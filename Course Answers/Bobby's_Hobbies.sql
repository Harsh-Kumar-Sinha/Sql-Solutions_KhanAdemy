...
INSERT INTO persons (name, age) VALUES ("Gutuli",1);
...
INSERT INTO hobbies (person_id, name) VALUES (5, "playing");

/* CROSS JOIN
SELECT * FROM persons,hobbies;
*/
/* IMPLICIT INNER JOIN
SELECT * FROM persons,hobbies WHERE persons.id = hobbies.id;
*/

/*EXCPLICIT INNER JOIN OR INNER JOIN*/
